...
module.exports = {
  ...
  // 🔒 Author protection
  // Fixed: the loader calls onLoad without binding `this` to module.exports,
  // so `this.config` was undefined here and crashed with
  // "Cannot read properties of undefined (reading 'author')" on every boot.
  // Referencing the module object directly (instead of `this`) keeps the
  // protection working without depending on call-site binding.
  onLoad: function () {
    if (module.exports.config.author !== "Rocky") {
