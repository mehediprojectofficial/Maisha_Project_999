...
module.exports.config = {
    ...
    version: "1.0.1",
    hasPermssion: 0,
    role: 0, // auto-added: this file used the non-standard "hasPermssion" field, which GoatBot's core does not read for permissions — role is the field it actually checks
    author: "HRIDOY",
    credits: "Hridoy",
    description: "Random anime recommendation pic",
    shortDescription: "Random anime recommendation pic", // auto-added: help menu reads shortDescription, not description
    category: "Image",
    usages: "send message",
    guide: "{pn}", // auto-added: help menu reads guide, not usages
    cooldowns: 5
};
