...
// FIX: was destructured at module load time -> crashed the whole bot
// on startup ("Cannot destructure property 'sequelize' of global.db")
// whenever this file is required before global.db exists. Now looked up
// lazily, only when the command actually runs.
function getSequelize() { return global.db.sequelize; }
