  ...
  onChat: async function ({ event, message, args }) {
    ...
    if (body.toLowerCase().startsWith(".emojivoice")) {
      ...
      if (commandArgs === "on") {
        ...
        return message.reply("✅ Emoji Voice System চালু করা হয়েছে।\nএখন ইমোজি পাঠালে ভয়েস আসবে 😍");
      }

      if (commandArgs === "off") {
        isEmojiVoiceEnabled = false;
        return message.reply("❌ Emoji Voice System বন্ধ করা হয়েছে।\nইমোজি দিয়ে আর ভয়েস আসবে না।");
      }
