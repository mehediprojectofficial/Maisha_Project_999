...
async function startBot(_0x3cad9e) {
  ...
  const fcaVersion = (() => { try { return JSON.parse(require("fs").readFileSync(require.resolve("hridoy-fca").replace(/index\.js$/, "package.json"), "utf8")).version; } catch { return "unknown"; } })();
